...
if __name__ == "__main__":
    ...
    infer(args)
    # --ckpt_path .\results\Patchcore\test\v3\weights\lightning\model.ckpt --output .\output\ --model anomalib.models.Patchcore --data.path .\datasets\test\bad\ --data.image_size 512